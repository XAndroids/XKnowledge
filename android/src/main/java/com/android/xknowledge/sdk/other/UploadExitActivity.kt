...
class UploadExitActivity : TitleActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lastUploadTimestamp = getPreferences(Context.MODE_PRIVATE).getLong(LAST_UPLOAD_TIMESTAMP, 0)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            Collections.sort(exitReasons, ExitReasonComparator())
            ...
            exitreasons_textview_info.text = result.toString()
        }
    }

    companion object {
        val LAST_UPLOAD_TIMESTAMP = "lastUploadTimestamp"
