...
import com.android.xknowledge.component.activity.distribute.DistributeMainActivity
...
class ActivityActivity : ListActivity() {
    override fun getMyListItemList(): List<ListItem> {
        return listOf(
            ...
            ListItem("Distribute", "跨组件Activity分发相关", DistributeMainActivity::class.java)
        )
    }
}